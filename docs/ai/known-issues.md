...
- **Regression tests**: `internal/services/google_oauth_service_test.go` (sanitizeReturnTo open-redirect guard, hashed-state persistence, state single-use/replay, resolveUser by-sub/link-email/create/race-fallback, audit-trail safety).
